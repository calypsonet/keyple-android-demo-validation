...
android {
    ...
    defaultConfig {
        applicationId("org.calypsonet.keyple.demo.validation.di")
        minSdkVersion(24)
        targetSdkVersion(29)
        versionCode(6)
    ...
    productFlavors {
        ...
        create("famoco") {
            dimension = "device"
            resValue("string", "app_name", "Keyple Validation Famoco")
            applicationIdSuffix = ".famoco"
        }
        create("bluebird") {
            dimension = "device"
            resValue("string", "app_name", "Keyple Validation Bluebird")
            applicationIdSuffix = ".bluebird"
        }
        create("flowbird") {
            dimension = "device"
            resValue("string", "app_name", "Keyple Validation Flowbird")
